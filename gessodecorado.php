    ...
    <div class="container-sm">
      ...
      <div class="card shadow-none bg-transparent mt-4">
        <img class="d-flex mt-3 mb-3 img-thumbnail text-center rounded mx-auto d-block"
          src="img/content/inicio/06.jpg" style="width: 350px" alt="Generic placeholder image">
        ...
        <div class="container-fluid text-center mb-4">
          <a href="img/pages/gessodecor/01.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="img/pages/gessodecor/01.jpg" alt="thumbnail"
