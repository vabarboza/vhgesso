    ...
    <div class="container-sm">
      ...
      <div class="card shadow-none bg-transparent mt-4">
        <img class="d-flex mt-3 mb-3 img-thumbnail text-center rounded mx-auto d-block"
          src="img/content/inicio/05.jpg" style="width: 350px" alt="Generic placeholder image">
        <div class="card-body text-center text-capitalize font-weight-bold">
        ...
        <div class="container-fluid text-center mb-4">
          <a href="img/content/inicio/05.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="img/content/inicio/05.jpg" alt="thumbnail"
          ...
          <a href="img/content/01.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="https://mdbootstrap.com/img/Others/documentation/img%20(75)-mini.jpg" alt="thumbnail"
              class="img-thumbnail" style="width: 100px" data-lightbox="image-1" data-title="My caption"></a>
