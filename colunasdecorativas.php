  ...
  <div class="container-fluid mt-3 mb-3">
    ...
    <div class="container-sm">
      ...
      <div class="card shadow-none bg-transparent mt-4">
        <img class="d-flex mt-3 mb-3 img-thumbnail text-center rounded mx-auto d-block" src="img/content/inicio/05.jpg" style="width: 350px" alt="Generic placeholder image">
        <div class="card-body text-center text-capitalize font-weight-bold">
          <p class="h5">Colunas Decorativas</p>
          <p class="card-text text-center ml-4 mr-4">As colunas são utilizadas na decoração do ambiente e são, também, muito utilizadas para a limitação (divisão) do ambiente.
        ...
        <div class="container-fluid text-center mb-4">
          <a href="img/content/inicio/05.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="img/content/inicio/05.jpg" alt="thumbnail" class="img-thumbnail" style="width: 100px" data-lightbox="image-1" data-title="My caption"></a>
