...
<body>
  ...
  <div class="container-fluid mt-3 mb-3">
    ...
    <div class="container-sm">
      ...
      <div class="card shadow-none bg-transparent mt-4">
        <img class="d-flex mt-3 mb-3 img-thumbnail text-center rounded mx-auto d-block" src="img/content/inicio/02.jpg" style="width: 350px" alt="Generic placeholder image">
        <div class="card-body text-center font-weight-bold">
          <p class="h5">Molduras</p>
          <p class="card-text text-center ml-4 mr-4">Molduras de Gesso há tempos é o toque final de acabamento colocando requinte nos perímetros dos ambientes,
        ...
        <div class="container-fluid text-center mb-4">
          <a href="img/content/inicio/02.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="img/content/inicio/02.jpg" alt="thumbnail" class="img-thumbnail" style="width: 100px" data-lightbox="image-1" data-title="My caption"></a>

          <a href="img/content/01.jpg" data-lightbox="image-1" data-title="My caption">
            <img src="https://mdbootstrap.com/img/Others/documentation/img%20(75)-mini.jpg" alt="thumbnail" class="img-thumbnail" style="width: 100px" data-lightbox="image-1" data-title="My caption"></a>
  ...
  <script src="https://www.gstatic.com/firebasejs/7.9.1/firebase-sanalytics.js"></script>
